...
class ShortcutButtonAlarm extends StatefulWidget {
  const ShortcutButtonAlarm({
    super.key,
  ...
  @override
  State<ShortcutButtonAlarm> createState() => _ShortcutButtonAlarmState();
}

class _ShortcutButtonAlarmState extends State<ShortcutButtonAlarm> {
  bool showMenu = false;
